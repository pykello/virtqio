...
[
  k cross
  pmat(\text{northward}; \text{separation}; \text{(miles)})
]^2
+
[
  \begin{matrix}
...
- John: $33.6900 cross 10^{-9}$ seconds
- Mary: $33.0228 cross 10^{-9}$ seconds
...
:::math
(\text{interval})^2 = [c cross pmat(\text{time}; \text{separation}; \text{(seconds)})]^2 - [pmat(\text{space}; \text{separation}; \text{(meters)})]^2
:::
...
:::math
(299792458 cross 33.6900 cross 10^{-9})^2 - (2)^2 = 98.010 \text{ meters}^2
:::

:::math
(299792458 cross 33.0228 cross 10^{-9})^2 - (0)^2 = 98.010 \text{ meters}^2
:::

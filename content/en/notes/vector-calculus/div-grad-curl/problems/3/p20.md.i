...
:::math align
\nabla dot v{E} &= \frac{rho}{eps_0} #tag M1
\nabla dot v{B} &= 0 #tag M2
\nabla cross v{E} &= - pd(v{B}, t) #tag M3
\nabla cross v{B} &= eps_0 mu_0 pd(v{E}, t) + mu_0 v{J} #tag M4
:::
...
:::math
\nabla dot pd(v{E}, t) = \frac{1}{eps_0} pd(rho, t) #tag 2
:::
